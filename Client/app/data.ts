import Logo from './Logo.png';  // If same folder
...
const footerSections = [
    ...
    },
    {
        sectionName: 'Contact',
        items: [
            {title:'Patna Bihar, India',link:"#"},
            {title:'+91 98765 43210',link:"#"},
            {title:'support@stylekart.Com',link:"#"}
        ]
    }
];
const featuresSec = [
...
const testimonial = {
    ...
    description:'Premium quality, lightning-fast delivery, exceptional service. Simply the best platform!'
}
...
const aboutUS= {
    section1:[
        {
            title:"About Us",
            description:"Welcome to Style Kart, your ultimate destination for all things fashion and lifestyle.. Founded 2025, we are passionate about delivering exceptional products and unparalleled shopping experiences to our customers worldwide.",
            imgLink:"about.jpg",
            imgAlt:""
        },
        {
            title:"Our Story",
            description:"At Style Kart, our journey began with a simple yet powerful vision: to redefine the online shopping experience. What started as a small venture has grown into a thriving e-commerce platform, serving customers across the globe with a diverse range of high-quality products.",
            imgLink:"about-1.jpg",
            imgAlt:""
        },
        {
    ...
    section3:{
        ...
        description:[
            ...
            "Thank you for choosing Style Kart. We look forward to serving you and helping you discover the joy of shopping online."
        ]
    }
}
