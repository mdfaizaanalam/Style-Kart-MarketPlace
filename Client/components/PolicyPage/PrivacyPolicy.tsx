  ...
  return (
    <div className='border-t-[1px]'>
        <div className="container mx-auto px-4 py-8 w-[80%]">
            <h1 className="text-4xl font-bold border-b-2 border-gray-300 pb-2 mb-8">Privacy Policy</h1>

            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">1. Introduction</h2>
                <p>We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy policy, or our practices with regards to your personal information, please contact us at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a>.</p>
            ...
            <section className="mb-8 flex flex-col gap-3 mt-5">
                ...
                <h3 className="text-xl font-semibold mb-1">Information Collected Automatically</h3>
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc list-inside ml-4 flex flex-col gap-3 mt-5">
                    ...
                    <li><strong>To enforce our terms, conditions, and policies for business purposes:</strong> To comply with legal and regulatory requirements or in connection with our contract.</li>
            ...
            <section className="mb-8">
                ...
                <p>Although we will do our best to protect your personal information, transmission of personal information to and from our website is at your own risk. You should only access the website within a secure environment.</p>
            </section>

            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">7. Do We Collect Information From Minors?</h2>
                <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the website, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the website. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we have collected from children under age 18, please contact us at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a>.</p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>If you are a resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" className="text-blue-500" target="_blank">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>.</p>
                <p>If you are a resident in Switzerland, the contact details for the data protection authorities are available here: <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" className="text-blue-500" target="_blank">https://www.edoeb.admin.ch/edoeb/en/home.html</a>.</p>
            </section>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">10. Do California Residents Have Specific Privacy Rights?</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">11. Do We Make Updates to This Policy?</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">12. How Can You Contact Us About This Policy?</h2>
                <p>If you have questions or comments about this policy, you may email us at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a> or by post to:</p>
