    ...
    <div className='border-t-[1px]'>
      <div className="container mx-auto px-4 py-8 w-[80%]">
          ...
          <section className="mb-8 flex flex-col gap-4">
              ...
              <p>You may cancel an order before it is shipped. To cancel an order, please contact our customer support team immediately at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a>. If the order has already been shipped, you will need to follow our return process to receive a refund.</p>
          ...
          <section className="mb-8">
              ...
              <p>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a> and send your item to: 123 Your Street, Your City, Your State, Your ZIP Code, Your Country.</p>
          </section>

          <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-2">7. Late or Missing Refunds</h2>
              <p>If you haven’t received a refund yet, first check your bank account again. Then contact your credit card company; it may take some time before your refund is officially posted. Next, contact your bank. There is often some processing time before a refund is posted. If you’ve done all of this and you still have not received your refund yet, please contact us at <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a>.</p>
          </section>
          ...
          <section className="mb-8">
              ...
              <address className="not-italic">
                  ...
                  Patna, Bihar<br></br>
                  India<br></br>
                  Email: <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a><br></br>
