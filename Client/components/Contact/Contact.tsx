            ...
            <section className="mb-8 flex flex-col gap-5">
                ...
                <div>
                    ...
                    <p>For general inquiries, order status, and support:
                        <a href="mailto:support@stylekart.com" className="text-blue-500">support@stylekart.com</a>
                    </p>
                    <p>For returns and refunds:
                        <a href="mailto:returns@stylekart.com" className="text-blue-500">returns@stylekart.com</a>
                    </p>
                </div>
                <div>
