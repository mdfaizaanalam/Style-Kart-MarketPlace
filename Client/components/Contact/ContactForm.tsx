...
const ContactForm = () => {
    ...
    async function formSubmit(e: any) {
        ...
        setTimeout(() => {
            ...
            setmessage("🎉 Successfully sent your message! We will contact you within 24 hours.");
                                ...
                                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div className="bg-white rounded-lg p-6 block">
                                        <a href="#" className="flex items-center mb-6">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">+91 98765 43210</h5>
                                        </a>
                                        <a href="#" className="flex items-center mb-6">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">support@stylekart.com</h5>
                                        </a>
                                        <a href="#" className="flex items-center">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">Patna, Bihar, India</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
